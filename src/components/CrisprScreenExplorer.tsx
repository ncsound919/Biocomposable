...
const targetsData: CrisprTarget[] = [
  {
    gene: "PARP1",
    l2fc: -3.85,
    fdr: 0.0001,
...
export function CrisprScreenExplorer() {
  const [selectedTarget, setSelectedTarget] = useState<CrisprTarget>(targetsData[0]);
      ...
      <div className="bg-[#18181B] border border-[#27272A] rounded-2xl p-5 flex flex-col gap-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="flex flex-col gap-2 justify-center bg-[#09090B] border border-[#27272A] p-3 rounded-xl font-mono text-[10px]">
            ...
            <div className="flex justify-between">
              <span className="text-[#71717A]">Synthetic Partner:</span>
              <span className="text-[#10B981] font-bold">BRCA1/2 HRD</span>
            </div>
          </div>
        </div>
      </div>

      {/* Grid of Targets and Visualizer */}
        ...
        <div className="lg:col-span-5 bg-[#18181B] border border-[#27272A] rounded-2xl p-5 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-3 font-mono text-[11px]">
            <div className="bg-[#09090B] border border-[#27272A] rounded-xl p-3 flex flex-col gap-1">
              ...
              <span className="text-sm font-bold text-[#10B981]">{selectedTarget.syntheticLethalityPartner}</span>
            </div>

            <div className="bg-[#09090B] border border-[#27272A] rounded-xl p-3 flex flex-col gap-1">
              <span className="text-[10px] text-[#71717A] uppercase">Lethal Mechanism</span>
              <p className="text-xs text-[#A1A1AA] leading-relaxed">{selectedTarget.mechanism}</p>
            </div>

            <div className="grid grid-cols-2 gap-3">
              <div className="bg-[#09090B] border border-[#27272A] rounded-xl p-3">
                <span className="text-[10px] text-[#71717A] uppercase block mb-1">sgRNA Efficiency</span>
